 ...
 */
const formatTheme = <F, G, I, L>(
  variables: ThemeVariables,
  theme: Partial<Theme<F, G, I, L>>
) => {
 ...
 */
const buildTheme = <F, G, I, L>(
  darkMode: boolean,
  baseTheme: Theme<F, G, I, L>,
  themeConfig: Partial<Theme<F, G, I, L>>,
  darkThemeConfig: Partial<Theme<F, G, I, L>>
) => {
  return {
 ...
 */
const mergeTheme = <F, G, I, L>(
  baseTheme: Theme<F, G, I, L>,
  theme: Partial<Theme<F, G, I, L>>,
  darkTheme: Partial<Theme<F, G, I, L>>
) =>
